...
public class BrowserPanelTest extends GuiUnitTest {
    private ExpensePanelSelectionChangedEvent selectionChangedEventStub;
    ...
    @Before
    public void setUp() {
        selectionChangedEventStub = new ExpensePanelSelectionChangedEvent(ALICE);
    ...
    public void display() throws Exception {
        ...
        URL expectedExpenseUrl = new URL(BrowserPanel.SEARCH_PAGE_URL
                + ALICE.getName().expenseName.replaceAll(" ", "%20"));
