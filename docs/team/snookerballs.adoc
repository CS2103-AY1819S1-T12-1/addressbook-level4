...
**Expense Tracker** was created for an NUS software Engineering module (CS2103T) under several https://nus-cs2103-ay1819s1.github.io/cs2103-website/admin/project-constraints.html[constraints].
